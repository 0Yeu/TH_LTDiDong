        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (txtName.getText().toString().isEmpty() && txtEmail.getText().toString().isEmpty() && txtPhone.getText().toString().isEmpty() && txtPassword.getText().toString().isEmpty() && txtRePassword.getText().toString().isEmpty()){
                    Toast.makeText(signup.this, "Ban can nhap thong tin !!!", Toast.LENGTH_SHORT).show();
                } else if (txtName.getText().toString().isEmpty()){
                    Toast.makeText(signup.this, "Ban can nhap Full Name !", Toast.LENGTH_SHORT).show();
                    txtName.requestFocus();
                } else if (txtEmail.getText().toString().isEmpty()){
                    Toast.makeText(signup.this, "Ban can nhap Email !", Toast.LENGTH_SHORT).show();
                    txtEmail.requestFocus();
                } else if (txtPhone.getText().toString().isEmpty()){
                    Toast.makeText(signup.this, "Ban can nhap Phone !", Toast.LENGTH_SHORT).show();
                    txtPhone.requestFocus();
                } else if (txtPassword.getText().toString().isEmpty()){
                    Toast.makeText(signup.this, "Ban can nhap Password !", Toast.LENGTH_SHORT).show();
                    txtPassword.requestFocus();
                } else if (txtRePassword.getText().toString().isEmpty()){
                    Toast.makeText(signup.this, "Ban can nhap Re-Password !", Toast.LENGTH_SHORT).show();
                    txtRePassword.requestFocus();
                } else {
                    Toast.makeText(signup.this, "Ban da dang ky thanh cong !", Toast.LENGTH_SHORT).show();
                    Toast.makeText(signup.this, "Moi ban dang nhap !", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(signup.this, login.class);
                    startActivity(intent);
                    finish();
                }
